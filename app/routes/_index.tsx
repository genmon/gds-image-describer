...
export default function Index() {
  ...
  return (
    <main className="flex flex-col items-center justify-center min-h-screen py-2 max-w-6xl mx-auto">
      <div className="absolute top-2 right-2 max-w-80 border border-1 border-gray-300 rounded p-2 text-gray-500 text-sm flex flex-col gap-2">
        <p>
          This demo uses the GPT-4 Vision API to generate alt text for images.
          It helps us understand where this can be useful and what the
          limitations are.{" "}
          <a
        ...
        <p>
          Limited to GOV.UK blogs, e.g. the{" "}
          <a
